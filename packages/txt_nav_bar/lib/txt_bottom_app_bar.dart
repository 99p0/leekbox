...
/// 指示器 还有凸出高度
///
class TxtBottomNavBar extends StatefulWidget {
  const TxtBottomNavBar({
    Key? key,
  ...
  @override
  _TxtBottomNavBarState createState() => _TxtBottomNavBarState();
}

class _TxtBottomNavBarState extends State<TxtBottomNavBar> with TickerProviderStateMixin {
