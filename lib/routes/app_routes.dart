...
import '../pages/go_home_page.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      if (isSplash) {
        return isAuth ? GoHomeScreen.routeLocation : LoginPage.routeLocation;
      }

      final isLoggingIn = state.location == LoginPage.routeLocation;
      if (isLoggingIn) return isAuth ? GoHomeScreen.routeLocation : null;
    ...
    routes: [
      ...
      GoRoute(
        path: GoHomeScreen.routeLocation,
        name: GoHomeScreen.routeName,
        builder: (context, state) {
          return const GoHomeScreen();
        },
      ),
      GoRoute(
