#!/usr/bin/env bash
#$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android-strip android/app/src/main/jniLibs/arm64-v8a/*
flutter build apk --split-per-abi --release --obfuscate --split-debug-info ./build/split-debug-info
#flutter build apk --target-platform android-arm64,android-arm --release --obfuscate --split-debug-info ./build/split-debug-info
